<div id="dashboard_modify_mobile_nav">
	<ul>
		<li><a href="dashboard_modify_mobile.php?modify_mobile_category=mobile_phones" class="active">Mobile Phones</a></li>
...
<form method="POST" action="" enctype="multipart/form-data">
	<h3>Add Mobile Phones to Database</h3>
	...
	<input type="hidden" name="add_what" value="add_mobile_phones"/>
