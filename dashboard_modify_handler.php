...
if(isset($_POST['add_what'])){
	...
	if($add_what=="add_mobile_phones"){
		...
		$desc=$_POST['desc'];
		$specs=$_POST['specs'];
		$query_product="INSERT INTO products(type,brand,name,price,description,specifications,thumbnail) VALUES('Mobile Phones','$brand','$name','$price','$desc','$specs','$destination')";
